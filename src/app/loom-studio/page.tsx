      ...
      >
        <div className="my-6 p-6">
          <div className="w-full h-[200px] md:h-[300px] lg:h-[400px] border border-dashed border-border rounded-lg bg-muted/50 flex items-center justify-center">
            <p className="text-muted-foreground dark:text-muted-foreground">Conceptual Diagram Area</p>
          </div>
        </div>
        
        <h3 className="font-headline text-xl text-primary dark:text-primary-foreground mt-8 mb-4">Key Capabilities:</h3>
        <ul className="list-disc list-inside space-y-3 text-foreground dark:text-foreground">
        ...
        <p className="mt-6 text-muted-foreground dark:text-muted-foreground">
