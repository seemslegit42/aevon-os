...
import { GitForkIcon, ArrowRightIcon } from '@/components/icons';
...
const LoomStudioCardContent: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center h-full text-center p-4">
      <GitForkIcon className="w-12 h-12 text-primary mb-4" />
      ...
      <Button asChild variant="outline" size="sm" className="mt-4">
        <Link href="/loom-studio">
          Go to Loom Studio <ArrowRightIcon className="ml-2 h-4 w-4" />
        </Link>
      </Button>
    </div>
  );
