...
const HomeIcon = forwardRef<SVGSVGElement, IconProps>(({ className, size, strokeWidth, id }, ref) => {
  return (
    <IconBase ref={ref} id={id} className={className} width={size} height={size} strokeWidth={strokeWidth} viewBox="0 0 24 24">
      ...
      <path d="M12 3L3 10.5V21h18V10.5L12 3Z" fill={`url(#${ICON_GRADIENT_ID})`} />
      {/* Roof highlight/separation (optional subtle facet) */}
      <path d="M12 3L3 10.5L12 18L21 10.5L12 3Z" fill="currentColor" opacity="0.6"/>
      {/* Door */}
      <path d="M10.5 14h3v5h-3v-5Z" fill="currentColor" opacity="0.8"/>
    </IconBase>
  );
});
