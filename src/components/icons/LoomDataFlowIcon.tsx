  ...
  return (
    <IconBase className={className} width={size} height={size} strokeWidth={sw} viewBox="0 0 24 24">
      ...
      <path d="M3 7s3-2 6-2 6 2 9 0M17 6.5l1-1.5-1-1.5" 
            fill="none" stroke={`url(#${ICON_GRADIENT_ID})`} strokeWidth={sw} strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M3 7.5s3-2 6-2 6 2 9 0M17 7l1-1.5-1-1.5" 
            fill="none" stroke={`url(#${ICON_GRADIENT_ID})`} strokeWidth={sw*0.5} strokeLinecap="round" strokeLinejoin="round" opacity="0.6"/>

      {/* Stream 2 (Right to Left, Middle, intertwining) */}
      <path d="M21 12s-3 2-6 2-4-1-6-1-4-1-6 0M7 12.5l-1 1.5 1 1.5" 
            fill="none" stroke={`url(#${ICON_GRADIENT_ID})`} strokeWidth={sw*0.9} strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M21 12.5s-3 2-6 2-4-1-6-1-4-1-6 0M7 13l-1 1.5 1 1.5" 
            fill="none" stroke={`url(#${ICON_GRADIENT_ID})`} strokeWidth={sw*0.45} strokeLinecap="round" strokeLinejoin="round" opacity="0.6"/>
