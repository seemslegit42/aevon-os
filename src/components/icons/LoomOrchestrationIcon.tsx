...
const LoomOrchestrationIcon: React.FC<IconProps> = ({ className, size, strokeWidth }) => {
  ...
  return (
    <IconBase className={className} width={size} height={size} strokeWidth={sw} viewBox="0 0 24 24">
      ...
      <g stroke="currentColor" fill="none" strokeWidth={sw * 0.5} strokeLinecap="round" strokeLinejoin="round">
        {/* Top to Mid-Left */}
        <path d="M10.5 8L7.5 11.5M8 10l-.5.75.5.75" />
        {/* Top to Mid-Right */}
        <path d="M13.5 8L16.5 11.5M16 10l.5.75-.5.75" />
        {/* Mid-Left to Bottom */}
        <path d="M7.5 15.5L10.5 19M8 17.5l.75-.5.75.5" transform="translate(0,1)"/>
        {/* Mid-Right to Bottom */}
        <path d="M16.5 15.5L13.5 19M16 17.5l-.75-.5-.75.5" transform="translate(0,1)"/>
      </g>
    </IconBase>
  );
};
