...
const ChatbotIcon: React.FC<IconProps> = ({ className, size, strokeWidth }) => {
  return (
    <IconBase className={className} width={size} height={size} strokeWidth={strokeWidth} viewBox="0 0 24 24">
      ...
      <path d="M20 3H4C3.17 3 2.5 3.67 2.5 4.5v11c0 .83.67 1.5 1.5 1.5h1.5v2.5l3.25-2.5H20c.83 0 1.5-.67 1.5-1.5v-11C21.5 3.67 20.83 3 20 3Z" fill={`url(#${ICON_GRADIENT_ID})`}/>
      
      {/* Facets with currentColor */}
      <g fill="currentColor">
