...
export const CreditCardIcon: React.FC<IconProps> = ({ className, size = 20, style }) => (
  ...
  >
    ...
    {/* Opacity layer can be a neutral subtle fill or removed if gradient handles the main shape */}
    {/* <rect x="32" y="48" width="192" height="160" rx="16" opacity="0.1" fill="#8C94A8"/> */}
